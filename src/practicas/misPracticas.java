...
public class misPracticas {
    ...
    public static boolean validaCaracteresEspecialesEnContraseña(String contraseña) {
    ...
    public static void practica17() {
        ...
        // practica 17: Array de numeros aleatorios, impresion de cada uno y la suma de
        // ellos
